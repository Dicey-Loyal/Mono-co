...
const GettingStarted = () => {
    ...
    return ( 
        <section className="getstartedbg">
            ...
            <h2 className="text-white text-3xl pt-32 font-dpsans font-medium pl-5 lg:text-6xl lg:mb-20" >Getting started</h2>
            <div className="px-5 my-5 lg:my-0">
            {
                gettingStartedUno.map((item) => (
                        <div key={item.id} className="bg-white px-5 mt-14 rounded-xl flex flex-col md:flex-row">
                             <div className="pt-8 flex flex-col justify-center items-center md:basis-2/4 md:items-start xl:px-10 xl:py-16">
                                <img src={item.icon} alt="" />
                                <h2 className="text-3xl text-center font-medium font-dpsans pt-5 md:text-6xl md:text-left md:py-6">{item.title}</h2>
