...
const GettingStarted = () => {
    ...
    return ( 
        <section className="getstartedbg pb-16">
            <div className="max-w-6xl mx-auto px-5 md:px-14 lg:px-0">
            <h2 className="text-white text-3xl pt-24 lg:pt-32 font-dpsans font-medium sm:pl-5 md:text-5xl lg:text-6xl lg:mb-20" >Getting started</h2>
            <div className="lg:px-5 py-3">
            {
                gettingStartedUno.map((item) => (
                        <div key={item.id} className="bg-white lg:px-5 mt-14 lg:mt-0 rounded-xl flex flex-col xl:flex-row">
                             <div className="pt-8 flex flex-col justify-center items-center xl:basis-2/4 xl:items-start xl:px-10 xl:py-16">
                                <img src={item.icon} alt="" />
                                <h2 className="text-3xl text-center font-medium font-dpsans pt-5 md:text-4xl xl:text-6xl xl:text-left md:py-6 max-w-xs md:max-w-full">{item.title}</h2>
            ...
            <div className="flex flex-col md:flex-row lg:px-5 gap-4">
                {
